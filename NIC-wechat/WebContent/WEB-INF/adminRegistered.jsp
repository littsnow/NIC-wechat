	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x"
				action="${pageContext.request.contextPath }/manager/registered">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="managerDuty" size="50"
							placeholder="请输入工作范畴" data-validate="required:工作范畴不许为空" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="text" class="input w50" name="managerTyp" size="50"
							placeholder="请输入类型" data-validate="required:类型不为空" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
