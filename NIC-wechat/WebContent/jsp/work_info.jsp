...
<body style="font-size: 40px;">
    <div class="register">
        ...
        <div class="content">
            ...
            <form action="${pageContext.request.contextPath }/user/addwork" method="post">
                <div class="message">
                <select name="job">
                        <option value="choose">选择业务类型</option>
                        <option value="boss">技术支持</option>
                        <option value="staff">设备报修</option>
                        <option value="staff">日常运维</option>
                    </select></br>
                <table style="width: 100%; font-size: 40px;">
                	...
                	<tr>
                		...
                		<td><input type=text placeholder="请输入具体描述" name="telephone"/></td>
                	</tr>
                	<tr>
                		<td> <label>具体地点：</label></td>
                		<td><input type=text placeholder="请输入具体地点" p name="telephone"/></td>
                	</tr>
                	<tr>
