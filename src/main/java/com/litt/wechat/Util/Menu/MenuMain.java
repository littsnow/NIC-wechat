...
public class MenuMain {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		button21.setUrl("http://85a2a1a7.ngrok.io/NIC-wechat/user/loadInfo");

		ViewButton button22 = new ViewButton();
		button22.setName("提交业务");
		button22.setType("view");
	//	button22.setUrl("http://demo.open.weixin.qq.com/jssdk");
		button22.setUrl("http://85a2a1a7.ngrok.io/NIC-wechat/jsp/work_info.jsp");
